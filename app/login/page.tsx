    ...
    <>
      <div>
        <div className="bg-[#FFF9DC] w-screen h-screen text-black flex-col flex justify-center items-center">
          ...
          <div className="bg-[#FFF7D1] w-[440px] h-[330px] border-2 border-black flex justify-center items-center flex-row rounded">
            <div>
              <div className="space-y-8 mb-2 mt-2">
              ...
              <div className="flex justify-center items-center flex-col">
                <div className="mt-6 flex justify-center items-center bg-[#FFE3A6] h-12 w-28 rounded-sm border-2 border-black text-center text-xl">
                  <button>Login</button>
                </div>

                <div className="text-[#5C5950] mt-8">
